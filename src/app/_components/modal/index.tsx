        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
            <div className="relative bg-white rounded-lg shadow-lg p-6 w-full max-w-sm">
                ...
                <div className="relative w-full mt-8 flex items-center">
                    ...
                    />
                    <button disabled={isCopied} onClick={copyLink} type="submit" className={`absolute inline-flex items-center gap-2 h-10 rounded-md p-2 text-xs right-3 top-1.2 text-white ${isCopied ? "bg-green-600": "bg-gray-700"}`}>
                        {isCopied? <BsClipboardCheck className='size-4'/> : <BiClipboard className="size-4"/>}
